...
from masif_modules.read_data_from_surface import read_data_from_surface_for_test, compute_shape_complementarity
...
for ppi_pair_id in input_ids:
    ...
    for pid in pids:
        input_feat[pid], rho[pid], theta[pid], mask[pid], neigh_indices[pid], verts[pid] = read_data_from_surface_for_test(ply_file[pid], params)

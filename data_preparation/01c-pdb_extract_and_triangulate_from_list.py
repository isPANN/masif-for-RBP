...
startidx=412
input_ids = extract_pdb_ids(RBP_list_path)[startidx:]
# print(input_ids)
# exit(1)
# input_ids = [['4qoz_C']]
for input in input_ids:
    in_fields = input[0].split("_")
    pdb_id = in_fields[0]
    ...
    if masif_opts['RNA_contact']:
        vertex_RNA_binding1 = assignChargesToNewMesh(regular_mesh.vertices, vertices1,\
            RNA_binding1, masif_opts)
        # for i in range(len(vertex_RNA_binding1)):
        #     print("vertex_RNA_binding1", vertex_RNA_binding1[i])
        vertex_RNA_binding2 = assignChargesToNewMesh(regular_mesh.vertices, vertices1,\
            RNA_binding2, masif_opts)
